...
Original file is located at
    https://colab.research.google.com/drive/1Aac-TDK5ZrmJ5x-Le4sQq-dz9VZd05vd
"""

pip install gradio

pip install llama-index-core chromadb openai

pip install llama-index-llms-huggingface

pip install llama-index-vector-stores-chroma llama-index-embeddings-huggingface
